...
*Intercom-at-the-Yard* is made with p5LiveMedia by @vanevery, a WebRTC library for p5.js. For more information about p5LiveMedia see Shawn's [github repo](https://github.com/vanevery/p5LiveMedia) here.
...
* Click the hamburger 🍔 menu 
  ![hamburger](documentation/intercom-hamburger.png) and select a zone and click *submit*. 
  ![zone](documentation/intercom-zone-select.png) 
  
To address the endpoint from a microphone simply...

* point your desktop or mobile browser (make sure it has a microphone connected 🎤) to your hosted clone of this repo. Select a zone using the touch interface
  ![zone](documentation/intercom-touch-1.png) 
...
## Attribution
Tommy Martinez [@ogbabydiesal](https://github.com/ogbabydiesal): hardware systems and programming

Ava Kling [website](https://www.avakling.info/): UI/UX Design

Shawn Van Every [@vanevery](https://github.com/vanevery): p5LiveMedia, main dependencies

Todd Bryant [website](https://toddjbryant.com/): Inspo and Encouragement

Isaiah Hashimoto(https://isaiahhashimoto.com): Blackhole Music Feature
